...
const Campsite =({backgroundImage,title}:CampProps)=>{
  return(
    <div className = {` object-none    h-full w-full bg-cover  ${backgroundImage}  bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl` } >
...
const Camp = () => {
  return (
    <section className = "h-full  2xl:max-conatiner relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20"> 
     <div className=" flex  flex-row gap-y-5 h-[340px] w-full items-start justify-start  lg:h-[400px] xl:h-[640px] ">
      <Campsite
